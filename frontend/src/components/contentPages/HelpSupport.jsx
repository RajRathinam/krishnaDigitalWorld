                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                            {supportCategories.map((category, index) => {
                                ...
                                return (
                                    <Component 
                                        key={category.title} 
                                        href={category.action || undefined} 
                                        data-aos="fade-up" 
                            ...
                            {services.map((service, index) => {
                                ...
                                return (
                                    <div 
                                        ...
                                        data-aos="fade-up" 
                                        data-aos-delay={index * 100} 
                                        className="group bg-card rounded-2xl p-6 border border-border/60 hover:border-accent/50 hover:shadow-xl transition-all duration-300"
                                    >
                        ...
                        <div className="max-w-3xl mx-auto" data-aos="fade-up">
                            <div className="space-y-4">
                                {faqItems.map((faq, index) => (
                                    <div 
                                        key={index} 
                                        className="group bg-card rounded-2xl p-6 border border-border/60 hover:border-accent/50 transition-all duration-300"
                                    >
