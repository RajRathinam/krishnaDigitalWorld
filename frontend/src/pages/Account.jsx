...
export default function Account() {
  ...
  const triggerSignupDialog = () => {
    // Set a flag to trigger signup on homepage
    localStorage.setItem('forceSignup', 'true');
    
    // Navigate to homepage
    navigate('/');
    
    // Dispatch event after a small delay to ensure page loads
    setTimeout(() => {
                ...
                {(!loading && !user) ? (
                  <div className="text-center py-12">
                    ...
                    <button
                      ...
                      className="inline-block bg-accent text-primary font-medium px-6 py-2 rounded-lg hover:bg-krishna-orange-hover transition-colors"
                    >
                      Sign in / Register
                    </button>
                  </div>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={fetchOrders}
                        className="text-sm text-krishna-blue-link hover:underline"
                ...
                {wishlistItems.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {wishlistItems.map((item) => (
                      <div key={item.id} className="bg-card rounded-lg border border-border p-4 flex flex-col">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 mt-auto">
                            ...
                            <button
                              ...
                              className="text-xs text-destructive hover:underline px-3 py-2 rounded hover:bg-destructive/10 transition-colors"
                            >
                              Remove
                            </button>
                          </div>
                  ...
                  <>
                      ...
                      {primaryAddress ? (
                        ...
                        <div className="bg-muted/30 p-4 rounded-lg border border-border">
                          ...
                          <button
                            ...
                            className="mt-2 text-sm text-krishna-blue-link hover:underline"
                          >
                            Go to Profile
                          </button>
                        </div>
                    ...
                    <div className="mb-6">
                      <h3 className="font-medium text-foreground mb-3">
                        Saved Addresses ({additionalAddresses.length})
                      </h3>
                      ...
                      {isLoadingAddresses ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {additionalAddresses.map((address) => (
                            ...
                            >
                              {address.isDefault && (
                                <span className="absolute top-2 right-2 text-xs bg-accent text-primary px-2 py-1 rounded">
                                  Default
                                </span>
                              )}
                        ...
                        <div className="bg-card rounded-lg border border-border p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
                          ...
                          <div className="flex gap-3 mt-6">
                            ...
                            <button
                              ...
                              className="flex-1 py-2 bg-accent text-primary font-medium rounded-lg hover:bg-krishna-orange-hover transition-colors"
                            >
