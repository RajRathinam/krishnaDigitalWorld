...
export default function Checkout() {
  ...
  const testBackendHealth = async () => {
    try {
      ...
      const knownEndpoints = ["/auth/me", "/cart", "/products"];
      ...
      {!user ? (
        ...
        <div className="text-center py-8">
          ...
          <button
            ...
            className="inline-block bg-accent text-primary font-medium px-6 py-2 rounded-lg"
          >
            + Add Address
          </button>
        </div>
        ...
        <>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {addr.isDefault && (
                      <span className="text-xs bg-accent/20 text-accent px-2 py-0.5 rounded">Default</span>
                    )}
                  </div>
          ...
          {selectedAddressData && (
            <button
              ...
              className="w-full py-3 bg-accent hover:bg-krishna-orange-hover text-primary font-medium rounded-lg transition-colors mt-4"
            >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      (orderPlaced && placedOrderData
                        ? parseFloat(placedOrderData.shippingCost)
                        : deliveryFee) === 0
                        ? "text-krishna-green"
                        : "text-foreground"
                    }
                  >
                    {(orderPlaced && placedOrderData
                      ...
                      : deliveryFee) === 0
                      ? "FREE"
                      : formatPrice(orderPlaced && placedOrderData ? placedOrderData.shippingCost : deliveryFee)}
                  </span>
                </div>
              </div>
