...
export default function OrderDetailScreen() {
  ...
  // Intercept Android hardware back button — prevent app exit
  useEffect(() => {
    const onBackPress = () => {
      if (router.canGoBack()) {
        router.back();
    ...
    return (
      <SafeAreaView style={styles.safe} edges={['left', 'right', 'bottom']}>
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24 }}>
          ...
          <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#111827', marginBottom: 8 }}>Order Not Found</Text>
          <Text style={{ fontSize: 14, color: '#6B7280', textAlign: 'center', marginBottom: 24 }}>
            We couldn't load the details for this order (ID: {id}). It might have been removed or there was a network error.
          </Text>
          <TouchableOpacity 
            onPress={() => router.canGoBack() ? router.back() : router.replace('/(tabs)')}
            style={{ paddingHorizontal: 24, paddingVertical: 12, backgroundColor: '#FFC107', borderRadius: 8 }}
          >
    ...
    <SafeAreaView style={styles.safe} edges={['left', 'right', 'bottom']}>
      ...
      >
        ...
        <View style={styles.headerRow}>
          <TouchableOpacity onPress={() => router.canGoBack() ? router.back() : router.replace('/account/orders')} style={styles.backBtn}>
              ...
              >
                <View style={{ flex: 1, padding: 12, paddingRight: 4, zIndex: 2 }}>
                  ...
                  <Text style={{ color: '#4B5563', fontSize: 11, lineHeight: 14, fontWeight: '500' }}>
                    You did not win a gift for this order.
                  </Text>
                </View>
